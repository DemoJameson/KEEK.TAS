...
public record struct GameInfoMessage : IGameToStudioMessage {
    ...
    public byte[] ToByteArray() {
        return BinaryFormatterHelper.ToByteArray(this);
    }

    // ReSharper disable once UnusedMember.Global
    public static GameInfoMessage FromByteArray(byte[] data) {
        return BinaryFormatterHelper.FromByteArray<GameInfoMessage>(data);
    }
}